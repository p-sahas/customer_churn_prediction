...
class FillMissingValuesStratergy(MissingValueHandlingStrategy):
    ...
    def __init__(
        ...
        self.relevent_column = relevent_column
    ...
    def handle(self, df):
        ...
        df[self.relevent_column] = df[self.relevent_column].fillna(df[self.relevent_column].mean())
        logging.info(f'Missing Values filled in column {self.relevent_column}.')
        return df