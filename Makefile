...
help:
	...
	@echo "  make clean-all           - 🗑️  Clean EVERYTHING (Local + RDS + ECS)"
	@echo "  make docker-clean-all-ecs - 🗑️  Clean ONLY ECS (keep local Docker)"
	@echo "  ./run_local.sh           - 🚀 Deploy LOCAL setup (recommended)"
	@echo "  make deploy-local        - 🚀 Deploy LOCAL setup (alternative)"
	@echo "  ./run_ecs.sh             - ☁️  Deploy ECS setup (use script only)"
	@echo ""
	@echo "📦 Setup Commands:"
...
docker-clean-all-ecs:
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@echo "🗑️  ECS CLEANUP - AWS Resources Only"
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@echo ""
	@echo "⚠️  WARNING: This will DELETE all ECS resources:"
	@echo "   • ECS Services (4)"
	...
	@echo "ℹ️  Local Docker environment will NOT be affected"
	@echo ""
	@read -p "Continue with ECS cleanup? (yes/no): " confirm; \
	if [ "$$confirm" != "yes" ]; then \
...
# 2️⃣ Deploy LOCAL setup end-to-end
deploy-local:
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	...
	@$(MAKE) docker-build
	@echo ""
	@echo "2️⃣ Building Airflow image..."
	@$(MAKE) airflow-build
	@echo ""
	@echo "3️⃣ Starting MLflow and pipeline services..."
	@$(MAKE) docker-up
	@echo ""
	@echo "4️⃣ Initializing Airflow (local PostgreSQL)..."
	@$(MAKE) airflow-init
	@echo ""
	@echo "5️⃣ Starting Airflow services..."
	@$(MAKE) airflow-up
	@echo ""
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# 3️⃣ Deploy ECS setup end-to-end
